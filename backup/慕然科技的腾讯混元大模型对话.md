...
(function(Scratch) {
    ...
    class TencentHunyuanExtension {
        ...
        sendMessage(args) {
            ...
            // 构建腾讯混元API请求数据[citation:2][citation:9]
            const requestData = {
            ...
            // 调用腾讯混元API[citation:2][citation:9][citation:10]
            return fetch('https://api.hunyuan.cloud.tencent.com/v1/chat/completions', {
                method: 'POST',
                headers: {
    ...
    Scratch.extensions.register(new TencentHunyuanExtension());
})(Scratch);
```